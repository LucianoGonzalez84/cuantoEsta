...
let currentSlide = 0;
const totalSlides = 5; // 5 items en el banner
...
// Helper para actualizar valores en desktop y mobile
function actualizarBannerValor(texto, idDesktop, idMobile) {
    const elemDesktop = document.getElementById(idDesktop);
    if (elemDesktop) elemDesktop.textContent = texto;
    
    const elemMobile = document.getElementById(idMobile);
    if (elemMobile) elemMobile.textContent = texto;
}
